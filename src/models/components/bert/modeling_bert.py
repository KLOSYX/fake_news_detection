...
# PyTorch BERT model.
# Oringinal code from HuggingFace transformers 4.21.1: https://github.com/huggingface/transformers/releases/tag/v4.21.1
import math
import os
import warnings
...
class BertModel(BertPreTrainedModel):
    ...
    To behave as an decoder the model needs to be initialized with the `is_decoder` argument of the
    configuration set to `True`. To be used in a Seq2Seq model, the model needs to initialized with
